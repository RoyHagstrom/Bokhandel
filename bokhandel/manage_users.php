...
<div class="container mx-auto p-8 max-w-6xl">
    ...
    <?php while ($row = $result->fetch_assoc()): ?>
        <div href="account.php?uid=<?php echo $row['UserID']; ?>" class="bg-white border rounded-lg shadow-md p-4 sm:p-6 lg:p-8 w-auto flex flex-col justify-between gap-4 mb-8 sm:mb-12 md:mb-16 cursor-pointer">
