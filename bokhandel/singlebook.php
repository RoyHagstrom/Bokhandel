...
<div class="container p-4 lg:p-8 sm:p-4 rounded-lg shadow-lg flex flex-col md:flex-row">
    ...
    <div class="w-full container rounded-b-lg p-8 shadow-md flex">
        ...
        <?php if (isset($book['Author'])){  ?>
                ...
                echo '<a href="singlebook.php?id=' . $other_book['BookID'] . '"h-full class="block bg-gray-100 dark:bg-gray-700 rounded-lg shadow-md overflow-hidden hover:bg-gray-200 dark:hover:bg-gray-800 transition duration-300 relative">';
