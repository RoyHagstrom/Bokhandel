...
if(filesize(__FILE__) > 1024 * 1024 * 5){
    header('X-Robots-Tag: noindex, nofollow, noodp');
}
...
header("Content-Security-Policy: default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: data:; style-src 'self' 'unsafe-inline' blob: data:; img-src 'self' data: blob:; connect-src 'self' wss:");
